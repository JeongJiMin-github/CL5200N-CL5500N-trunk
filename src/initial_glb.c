...
//	{  310,	     0, 	GLOBAL_SALE_SETUP_FLAG2,     	FLASH_GLOBAL_AREA,		1,    	    4,	     4,	       1,	COUNTRY_KR},  //   Use Double Speed Key
	...
	{  323,	     1,		GLOBAL_SALE_SETUP_FLAG10,	FLASH_GLOBAL_AREA,		1,    	    4,	     6,	       2,	COUNTRY_KR}, //Menu1873 Use double/togle key
#elif (defined(USE_GSMART_DEFAULT) || defined(USE_GSMART_TRACE_DEFAULT) || defined(USE_LOTTEMART_DEFAULT))
