 /* 
 * File:   KOR_IMPORT_MEAT_8LINE_I8.h
 * Author: idhwang
 * @brief  globals.h에서 분리된 독립형 + 상품명 8단 전용 파일, 딜러롬 신규 파생
 *         상품명 8단 기능 적용으로 인한 PLU, Ingredients 개수 변경됨
 *         PLU : 8,000 -> 6,000 EA / Ingridients : 16,000 -> 200 EA     
 * Create 2024/08/01
 */

#ifndef KOR_IMPORT_8LINE_H
#define KOR_IMPORT_8LINE_H

//----------   국가 Default  ----------//
 #define DEALER_VER_STRING	".I8"
 #define COUNTRY_STR "  "
